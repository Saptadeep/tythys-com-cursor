...
export function HUD() {
  ...
  // Keep the pill a few px above the footer top border when footer is visible.
  useEffect(() => {
    const base = 18
    const bump = () => {
  ...
  return (
    <div
      ref={rootRef}
      className="fixed right-4 z-[150] flex flex-col items-end gap-1.5 sm:right-5"
