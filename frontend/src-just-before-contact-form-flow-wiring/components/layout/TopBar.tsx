...
export function TopBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[200] flex h-[24px] items-center overflow-hidden"
         style={{ background: 'rgba(4,8,15,0.95)' }}>

      {/* Full-width gradient line — colour changes with health state */}
      <div className={cn('h-[2px] flex-shrink-0 w-full absolute top-0 left-0 right-0 bg-gradient-to-r opacity-80', cfg.bar)} />

      {/* Invisible spacer to push content below the line */}
